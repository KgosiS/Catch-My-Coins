...
class AddExpenseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val categories = listOf("Food", "Transport", "Entertainment", "Bills", "Shopping", "Health", "Other")
        ...
        createButton.setOnClickListener {
            ...
            if (title.isEmpty() || description.isEmpty() || category.isNullOrEmpty() || date.isEmpty() || startTime.isEmpty() || endTime.isEmpty() || amount == null) {
                ...
                val success = dbHelper.insertExpense(title, description, amount, category, date, startTime, endTime, photoUri)
                if (success) {
